...
export default function FormPackages(props: FormPackageProps) {
  const schemaPackages = Yup.object().shape({
    ...
    description: Yup.string()
      ...
      review: Yup.string()
      .max(100, "El review del paquete debe de tener menos de 50 caracteres")
  });
  ...
  return (
    <Formik
      ...
      onSubmit={(values, actions) => {
        ...
        values.branchesIds = warehousesSelected.map((value) => value.key);
        ...
        <Form>
          ...
          <div className="form-group">
            <TypeAheadProvider
              ...
              listUI={(provider: providerPackageDTO) => (
                <>
                  {provider.name}  
                </>
              )
...
interface FormPackageProps {
  ...
  providersSelected: providerPackageDTO[];
}
